  ...
  def render(assigns) do
    ...
    <div class="min-h-screen bg-gradient-to-br from-white via-green-50 to-emerald-50">
      ...
      <div class="absolute inset-0 overflow-hidden pointer-events-none">
        <div class="absolute top-24 left-20 w-20 h-20 bg-gradient-to-r from-emerald-300 to-teal-300 blob opacity-20 float-slow">
        </div>
        <div class="absolute bottom-40 right-16 w-16 h-16 bg-gradient-to-r from-green-300 to-lime-300 blob-2 opacity-25 float-medium">
        </div>
        <div
          class="absolute top-1/3 left-1/2 w-14 h-28 bg-gradient-to-b from-orange-200 to-amber-200 opacity-30 transform rotate-12"
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div class="text-center mb-16">
            <div class="relative inline-block mb-2">
              ...
              <span class="handwritten text-lg text-orange-500 absolute -top-4 -right-12 transform rotate-12">
                things I built!
              </span>
            </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div class="mb-16">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
              <.project_card
                :for={project <- Enum.filter(@projects, & &1.featured)}
                project={project}
                featured={true}
              />
            </div>
      ...
      <div class="p-6">
        ...
        <div class="flex items-center space-x-6 pt-4 border-t border-green-100">
          <%= if @project.github_url do %>
            ...
            >
              <svg
                class="w-5 h-5 mr-2 group-hover/link:scale-110 transition-transform"
                fill="currentColor"
                viewBox="0 0 24 24"
              >
