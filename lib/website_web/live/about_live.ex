  ...
  def render(assigns) do
    ...
    <div class="min-h-screen bg-gradient-to-br from-white via-green-50 to-emerald-50">
      ...
      <div class="absolute inset-0 overflow-hidden pointer-events-none">
        <div class="absolute top-32 right-20 w-20 h-20 bg-gradient-to-r from-teal-300 to-emerald-300 blob opacity-20 float-slow">
        </div>
        <div class="absolute bottom-40 left-16 w-16 h-16 bg-gradient-to-r from-green-300 to-lime-300 blob-2 opacity-25 float-medium">
        </div>
        <div
          class="absolute top-1/2 right-1/4 w-12 h-24 bg-gradient-to-b from-orange-200 to-amber-200 opacity-30 transform rotate-45"
          style="border-radius: 50% 20% 80% 30% / 60% 70% 30% 40%;"
        >
        </div>
      </div>
      <!-- Hero Section -->
          ...
          <div class="text-center">
            <div class="relative inline-block">
              <h1 class="text-4xl sm:text-5xl lg:text-6xl font-display font-bold text-slate-900">
                About
                <span class="bg-gradient-to-r from-emerald-600 to-teal-600 bg-clip-text text-transparent font-flower transform -rotate-1 inline-block">
                  Me
                </span>
              </h1>
              <span class="handwritten text-lg text-orange-500 absolute -top-4 -right-8 transform rotate-12">
            ...
            <div class="card p-8 bg-white">
              <div class="flex items-start mb-6">
                ...
                <div>
                  ...
                  <span class="handwritten text-orange-500 text-sm transform -rotate-2 inline-block">
              ...
              <div class="prose prose-lg max-w-none">
                ...
                <p class="text-slate-600 leading-relaxed mb-4">
                  I've also been lucky enough to get a start in data engineering and data pipeline building and maintenance using
                  <span class="font-mono bg-green-100 px-2 py-1 rounded text-green-700">PySpark</span>
                  and various AWS technologies including Glue Jobs, Step Functions, Lambdas, and Athena.
                </p>
                <p class="text-slate-600 leading-relaxed">
                  Outside of work, I'm mostly dabbling with
                  <span class="font-mono bg-teal-100 px-2 py-1 rounded text-teal-700">
                    Elixir and Phoenix
                  </span> <span class="handwritten text-orange-500">(like this site!)</span>. After years of Object Oriented Programming, using a purely functional language has been a breath of fresh air.
                </p>
              </div>
            </div>
            ...
            <div class="card p-8 bg-white">
              <div class="flex items-start mb-6">
                ...
                <div>
                  ...
                  <span class="handwritten text-emerald-500 text-sm transform rotate-1 inline-block">
                    the fun stuff!
                  </span>
                </div>
              </div>
              <div class="prose prose-lg max-w-none">
                <p class="text-slate-600 leading-relaxed mb-4">
                  I like to think I'm pretty diverse and have a very whacky assortment of hobbies outside of programming. I run
                  <span class="font-semibold text-orange-600">D&D games</span>
                  for my friends (and sometimes at work), I love watching and playing hockey, and besides your nonna I
                  <em>might</em>
                  just be the best cook you know
                  <span class="handwritten text-orange-500">
                    (as long as you don't catch me experimenting!)
                  </span>
                </p>
                <p class="text-slate-500 italic flex items-center">
                  <span class="mr-2">🏌️‍♂️</span> Still trying to break 100 on the golf course though...
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="card p-8 bg-white">
            <div class="flex items-start mb-6">
              ...
              <div>
                ...
                <span class="handwritten text-teal-500 text-sm transform rotate-2 inline-block">
                  moments captured!
                </span>
              </div>
            </div>
            ...
            <div class="flex flex-wrap gap-3 mb-8">
              <%= for category <- @categories do %>
                <button
                  ...
                  style={
                    if @selected_category == category,
                      do: "border-radius: var(--border-organic);",
                      else: "border-radius: var(--border-quirky);"
                  }
                >
                  <%= category %>
                </button>
