defmodule WebsiteWeb.BlogLive.Index do
  ...
  def handle_event("filter_category", %{"category_id" => category_id}, socket) do
    ...
    if socket.assigns.loading do
      ...
      case parse_integer(category_id) do
        nil ->
          {:noreply, socket}
  ...
  def render(assigns) do
    ...
    <div class="min-h-screen bg-gradient-to-br from-white via-green-50 to-emerald-50">
      ...
      <div class="absolute inset-0 overflow-hidden pointer-events-none">
        <div class="absolute top-24 right-12 w-20 h-20 bg-gradient-to-r from-emerald-300 to-teal-300 blob opacity-20 float-slow">
        </div>
        <div class="absolute bottom-40 left-20 w-16 h-16 bg-gradient-to-r from-green-300 to-lime-300 blob-2 opacity-25 float-medium">
        </div>
        <div
          class="absolute top-1/2 right-1/3 w-12 h-24 bg-gradient-to-b from-orange-200 to-amber-200 opacity-30 transform rotate-12"
          style="border-radius: 60% 40% 80% 20% / 30% 70% 30% 70%;"
        >
        </div>
      </div>
      <!-- Hero Section -->
          ...
          <div class="text-center mb-16">
            <div class="relative inline-block mb-2">
              <h1 class="text-4xl sm:text-5xl lg:text-6xl font-display font-bold text-slate-900 mb-8 pb-2">
                <span class="bg-gradient-to-r from-emerald-600 to-teal-600 bg-clip-text text-transparent font-flower transform -rotate-1 inline-block pb-4 px-4">
                  Blog
                </span>
              </h1>
            ...
            <p class="text-xl text-slate-600 max-w-3xl mx-auto leading-relaxed">
              ...
              <span class="font-mono bg-green-100 px-2 py-1 rounded text-emerald-700 block mt-2">
                Fresh ideas served...occasionally!
              </span>
            </p>
          </div>
        </div>
          ...
          <div class="flex justify-center">
            <div class="flex flex-wrap justify-center gap-3 max-w-4xl">
              ...
              <button
                ...
                disabled={@loading}
                class={[
                  "inline-flex items-center px-4 py-2 rounded-full text-sm font-semibold transition-all duration-300 hover:scale-105 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100",
