  ...
  def render(assigns) do
    ...
    <article class="min-h-screen bg-gradient-to-br from-white via-green-50 to-emerald-50">
      ...
      <div class="absolute inset-0 overflow-hidden pointer-events-none">
        <div class="absolute top-32 left-16 w-20 h-20 bg-gradient-to-r from-teal-300 to-emerald-300 blob opacity-20 float-slow">
        </div>
        <div class="absolute bottom-40 right-12 w-16 h-16 bg-gradient-to-r from-green-300 to-lime-300 blob-2 opacity-25 float-medium">
        </div>
        <div
      ...
      <section class="pt-20 pb-16 relative">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div class="mb-8">
            <.link
              navigate={~p"/blog"}
              class="inline-flex items-center text-slate-600 hover:text-emerald-600 transition-all duration-300 group font-medium"
            >
              <svg
      ...
      <section class="pb-20">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div class="mb-4">
            <span class="handwritten text-orange-500 text-lg transform -rotate-1 inline-block">
              more brain dumps await!
            </span>
          </div>
          <.link
            navigate={~p"/blog"}
            class="inline-flex items-center px-8 py-4 bg-gradient-to-r from-emerald-500 to-teal-500 text-white font-semibold rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 group"
          >
            <svg
              class="w-5 h-5 mr-2 transition-transform group-hover:-translate-x-1"
              fill="none"
