defmodule WebsiteWeb.WorkLive do
  ...
  def render(assigns) do
    ...
    <div class="min-h-screen bg-gradient-to-br from-white via-green-50 to-emerald-50">
      ...
      <div class="absolute inset-0 overflow-hidden pointer-events-none">
        <div class="absolute top-20 left-16 w-24 h-24 bg-gradient-to-r from-emerald-300 to-teal-300 blob opacity-20 float-slow">
        </div>
        <div class="absolute bottom-32 right-20 w-16 h-16 bg-gradient-to-r from-green-300 to-lime-300 blob-2 opacity-25 float-medium">
        </div>
        <div
          class="absolute top-1/3 left-1/4 w-14 h-28 bg-gradient-to-b from-orange-200 to-amber-200 opacity-30 transform -rotate-12"
          style="border-radius: 70% 30% 40% 60% / 80% 20% 60% 40%;"
        >
        </div>
      </div>
      <!-- Hero Section -->
            ...
            <div class="space-y-8">
              <div class="mb-8">
                <div class="flex items-start">
                  ...
                  <div>
                    <h2 class="text-3xl font-display font-bold text-slate-900 mb-2">
                      Professional Experience
                    </h2>
                    <span class="handwritten text-orange-500 text-sm transform -rotate-1 inline-block">
                      building & learning
                    </span>
              ...
              <div class="relative">
                <!-- Timeline line -->
                <div class="absolute left-8 top-0 bottom-0 w-1 bg-gradient-to-b from-emerald-500 to-teal-500 rounded-full">
                </div>
    ...
    <div class="text-center mb-16">
      <div class="relative inline-block mb-2">
        <h1 class="text-4xl sm:text-5xl lg:text-6xl font-display font-bold text-slate-900 mb-8 pb-2">
          My
          <span class="bg-gradient-to-r from-emerald-600 to-teal-600 bg-clip-text text-transparent font-flower transform -rotate-1 inline-block pb-4">
            Journey
          </span>
        </h1>
        <span class="handwritten text-lg text-orange-500 absolute -top-2 -right-12 transform rotate-12">
          career path!
        </span>
      </div>
      <p class="text-xl text-slate-600 max-w-3xl mx-auto leading-relaxed">
        From student to professional developer - here's the path that shaped my career.
        <span class="font-mono bg-green-100 px-2 py-1 rounded text-emerald-700 ml-2">
          Let's dive in!
        </span>
      </p>
    </div>
  ...
  def timeline_card(assigns) do
    ...
    <div class="relative pl-20 pb-8">
      <!-- Timeline marker -->
      <div class="absolute left-6 w-4 h-4 bg-gradient-to-r from-emerald-600 to-teal-500 rounded-full shadow-lg">
      </div>
      <!-- Content card -->
        ...
        <div class="space-y-3">
          <%= for point <- @points do %>
            <div class="flex items-start">
              ...
              <% else %>
                <svg
                  class="w-5 h-5 text-emerald-500 mt-0.5 mr-3 flex-shrink-0"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
