  ...
  def render(assigns) do
    ...
    <div class="relative overflow-hidden bg-gradient-to-br from-white via-green-50 to-emerald-50 min-h-screen">
      ...
      <div class="absolute inset-0 overflow-hidden pointer-events-none">
        <!-- Floating blobs -->
        <div class="absolute top-20 left-10 w-32 h-32 bg-gradient-to-r from-emerald-400 to-green-400 blob opacity-20 float-slow">
        </div>
        ...
        <div class="max-w-5xl mx-auto text-center">
          ...
          <div class="space-y-8">
            ...
            <div class="relative mb-8">
              <span class="handwritten text-2xl absolute -top-8 -left-4 transform -rotate-12">
                Hey there! 👋
              </span>
            </div>
            ...
            <div class="max-w-3xl mx-auto space-y-4">
              <p class="text-lg sm:text-xl text-slate-600 leading-relaxed">
                I'm a
                <span class="font-mono bg-green-100 px-2 py-1 rounded text-emerald-700">
                  software developer
                </span>
            ...
            <div class="space-y-6 pt-8">
              <div class="flex flex-col sm:flex-row gap-6 justify-center items-center">
                ...
                <a href="/blog" class="btn-secondary group">
                  ...
                  <svg
                    class="w-5 h-5 ml-3 transition-transform group-hover:scale-110"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
              ...
              <div class="text-center">
                <p class="text-sm text-slate-500 font-mono">
                  <span class="handwritten text-base text-orange-500 transform rotate-3 inline-block mr-2">
                    psst:
                  </span>
                  check out my
                  <a
                    href="/work"
                    class="text-emerald-600 hover:text-emerald-700 underline decoration-wavy decoration-green-400"
                  >
                    work
                  </a>
                  or browse my
                  <a
                    href="/projects"
                    class="text-teal-600 hover:text-teal-700 underline decoration-wavy decoration-emerald-400"
                  >
                    projects
                  </a>
                </p>
